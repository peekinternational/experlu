                ...
                <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{$total_partner}}
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{$actvice_partner}}
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{$quote_pending}}
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 col-md-12">
                    <div class="numbers">
                      ...
                      <p class="card-title">{{$daily_earning}} £
                        <p>
                    </div>
                  </div>
                </div>
