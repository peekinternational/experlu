        ...
        <div class="row">
          ...
          <form class="form-horizontal employers-form" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6">
                      <input type="text" class="form-control" name="name" required="" value="{{ $user['name'] != '' ? $user['name'] : old('name') }}">
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group radio-div">
                  ...
                  <div class="col-md-6 radio-div">
                      <label class="custom-control custom-control-primary custom-radio">
                          <input name="role" class="custom-control-input" type="radio" value="jobs" {{ $user['role'] == 'jobs' ? 'checked="checked"' : '' }}>
                          <span class="custom-control-indicator"></span>
                          <span class="custom-control-label">Jobs</span>
                      </label>
                      <label class="custom-control custom-control-primary custom-radio" style="margin-left:20px;">
                          <input name="role" class="custom-control-input" type="radio" value="quote" {{ $user['role'] == 'quote' ? 'checked="checked"' : '' }}>
                          <span class="custom-control-indicator"></span>
              ...
              <div class="form-group">
                  ...
                  <form class="form-horizontal employers-form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6 radio-div">
                              <label class="custom-control custom-control-primary custom-radio">
                                  <input name="role" class="custom-control-input" type="radio" value="jobs" checked>
                                  <span class="custom-control-indicator"></span>
                                  <span class="custom-control-label">Jobs</span>
                              </label>
                              <label class="custom-control custom-control-primary custom-radio" style="margin-left:20px;">
                                  <input name="role" class="custom-control-input" type="radio" value="quote">
                                  <span class="custom-control-indicator"></span>
                                  <span class="custom-control-label">Quote</span>
                              </label>
                          </div>
